...
mat_data = sio.loadmat('./Datasets/Botswana/Botswana.mat')
data_IN = mat_data['Botswana']

mat_gt = sio.loadmat('./Datasets/Botswana/Botswana_gt.mat')
...
# Train:Val:Test=1:1:8 2:1:7 3:1:6 4:1:5 5:1:4
VALIDATION_SPLIT = 0.7  # Val+Test=0.9 0.8 0.7 0.6 0.5
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = './models/Indian_best_RSA_3_1_6_100_' + str(index_iter + 1) + '.hdf5'
    ...
    with open('./Loss_Acc/IN_RGCA_3_1_6_100_1.hdf5.hdf5.hdf5', 'w') as f:
...
modelStatsRecord.outputStats(KAPPA_3D_DenseNet, OA_3D_DenseNet, AA_3D_DenseNet, ELEMENT_ACC_3D_DenseNet,
                             ...
                             './records/IN_train_RGCSA_3_1_6_100_1.txt',
                             './records/IN_train_element_RGCSA_3_3_1_6_100_1.txt')
