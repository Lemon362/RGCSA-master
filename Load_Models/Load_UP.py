...
uPavia = sio.loadmat('D:/RGCSA/Datasets/UP/PaviaU.mat')
gt_uPavia = sio.loadmat('D:/RGCSA/Datasets/UP/PaviaU_gt.mat')
...
TOTAL_SIZE = 42776
VAL_SIZE = 4281
TRAIN_SIZE = 8558  # 8558 12838 17113 21391 25670
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'D:/RGCSA/models/UP_best_RGCSA_2_1_7_100_' \
...
modelStatsRecord.outputStats_assess(KAPPA_3D_DenseNet, OA_3D_DenseNet, AA_3D_DenseNet,
                                    ...
                                    'D:/RGCSA/records/UP_test_RGCSA_2_1_7_100_1.txt',
                                    'D:/RGCSA/records/UP_test_element_RGCSA_2_1_7_100_1.txt')
