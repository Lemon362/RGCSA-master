...
mat_data = sio.loadmat('D:/RGCSA/Datasets/KSC/KSC.mat')
data_IN = mat_data['KSC']
mat_gt = sio.loadmat('D:/RGCSA/Datasets/KSC/KSC_gt.mat')
gt_IN = mat_gt['KSC_gt']
print(data_IN.shape)
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'D:/RGCSA/models/KSC_best_RGCSA_2_1_7_100_' + str(
        index_iter + 1) + '.hdf5'
    ...
    classification_map(y_re, gt_IN, 24, "D:/RGCSA/CMaps/KSC_RGCSA_2_1_7_100_1.png")
