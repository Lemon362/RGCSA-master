...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = \
        'D:/RGCSA/models/UP_best_RRGCSA_2_1_7_100_' + str(
            index_iter + 1) + '.hdf5'
    ...
    classification_map(y_re, gt_IN, 24,
                       "D:/RGCSA/CMaps/UP_RGCSA_2_1_7_100_1.png")
