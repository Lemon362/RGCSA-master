...
def model_DenseNet():
    model_dense = RGCSA.ResneXt_IN((1, img_rows, img_cols, img_channels), classes=13)
    ...
    model_dense.summary()
    # plot_model(model_dense, show_shapes=True, to_file='./model_ResNeXt_GroupChannel_Space_Attention_KSC.png')
...
VALIDATION_SPLIT = 0.8  # Val+Test=0.8 0.7 0.6 0.5 0.4
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = './models/KSC_best_RGCSA_2_1_7_100_' + str(index_iter + 1) + '.hdf5'
    ...
    with open('./Loss_Acc/KSC_RGCSA_2_1_7_100_1.hdf5', 'w') as f:
...
modelStatsRecord.outputStats(KAPPA_3D_DenseNet, OA_3D_DenseNet, AA_3D_DenseNet, ELEMENT_ACC_3D_DenseNet,
                             ...
                             './records/KSC_train_RGCSA_2_1_7_100_1.txt',
                             './records/KSC_train_element_RGCSA_2_1_7_100_1.txt')
